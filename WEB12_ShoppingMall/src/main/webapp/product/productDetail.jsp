	...
	<div id="itemdetail">
		...
		<form method="post" name="formm">
			...
			<fieldset><legend>Item detail Info</legend>
				...
				<label>수량 : </label><input type="text" name="quantity" size="2" value="1"><br>
			...
			<div id="buttons">
				...
				<input type="button" value="즉시 구매" class= "submit" onclick="go_cart();">
				<input type="button" value="뒤로" class= "cancel" onclick="go_cart();">
			</div>
		</form>
	</div>
</article>
