...
<h1>사용자 등록</h1>
	<form name="frm" method="post" action="board.do">
		...
		<table>
			...
			<tr><th>등급</th><td><input type="radio" name="admin" value="0" checked="checked">일반회원
				<input type="radio" name="admin" value="1">관리자</td></tr>
		</table><br><br>
		<input type="submit" value="등록" onclick="return joinCheck()">
		<input type="reset" value="다시 작성">
		<input type="button" value="목록으로" onclick="location.href='board.do?command=loginForm'">
	</form>
</div>

<!-- joinFormAction 클래스를 member 패키지에 제작. joinForm.jsp로 forward
	joinAction 클래스 제작해서 회원가입 가능하도록 코딩해주세요. 필요한 사항은 임의로 작성해도 무방합니다. -->
</body>
</html>
