...
<form action="update.do" method="post" name="frm">
	<table>
		...
		<tr><td>아이디</td><td>${loginUser.userid}<input type="hidden" name="userid" value="${loginUser.userid}" />
			</td></tr>
		...
		<tr><td>이메일</td><td><input type="text" name="email" value="${loginUser.email}"  size="20"/></td></tr>
		<tr><td>전화</td><td><input type="text" name="phone" value="${loginUser.phone}"  size="20"/></td></tr>
