...
<div id="wrap" align="center">
	...
	<table class="list">
		...
		<tr><th>번호</th><th>제목</th><th>가격</th><th>수정버튼</th><th>삭제버튼</th></tr>
		<c:forEach var="product" items="${productList}">
			<tr class="record">
				...
				<td align="center">
					<a href="product.do?command=updateForm&code=${product.code}">상품 수정</a></td>
				<td align="center">
					<a href="product.do?command=delete&code=${product.code}">상품 삭제</a></td>
			</tr>
		</c:forEach>
	</table>
</div>
