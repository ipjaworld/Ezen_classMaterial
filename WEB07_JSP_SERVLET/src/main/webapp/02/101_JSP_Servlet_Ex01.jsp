...
<body>
	<form method="post" action="../Join_Servlet">
        ...
        <input type="checkbox" name="item" id="item" value="1">신발
        <input type="checkbox" name="item" id="item" value="2">가방
        <input type="checkbox" name="item" id="item" value="3">벨트<br>
        <input type="checkbox" name="item" id="item" value="4">모자
        <input type="checkbox" name="item" id="item" value="5">시계
        <input type="checkbox" name="item" id="item" value="6">쥬얼리<br><br>
